...
function AddDoctor() {
  ...
  return (
    <form className='m-5 w-full' onSubmit={onSubmitHandler}>
          <p className='text-l font-medium mb-3'>Add Doctor</p>
          <div className='bg-white px-8 py-8 borrder rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll '>
            ...
            <button type='submit' className='bg-gray-700 py-3 px-10 mt-4 text-white rounded-full'>Add doctor</button>
          </div>
